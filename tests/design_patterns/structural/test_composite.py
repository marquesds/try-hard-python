...
class TestComposite:
    def test_should_is_composite_be_false_when_leaf_object(self):
        assert BiologySubject().is_composite() == False

    def test_should_is_composite_be_true_when_composite_object(self):
        assert Composite().is_composite() == True

    def test_should_add_component_when_composite_object(self):
        obj1 = Composite()
        obj2 = Composite()
        obj1.add(obj2)
    ...
    def test_should_remove_component_when_composite_object(self):
        obj1 = Composite()
        obj2 = Composite()
        obj1.add(obj2)
    ...
    def test_should_get_one_subject_when_leaf(self):
        assert get_biology_subject() == "Biology"

    def test_should_get_all_children_subjects_when_composite(self):
