...
class TestBridge:
    def test_should_show_windows_user_folder_when_using_windows_implementation(self) -> None:
        assert show_windows_user_folder() == "C:/Users/lucas"

    def test_should_show_linux_user_folder_when_using_linux_implementation(self) -> None:
